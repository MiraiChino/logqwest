...
CHECK_LOCATION_TEMPLATE_FILE = PROMPT_DIR / "check_location.txt"
...
ADVCHECK_KEYS = config["ADVCHECK_KEYS"]
ADVCHECK_HEADERS = config["ADVCHECK_HEADERS"]
LOCATIONCHECK_KEYS = config["LOCATIONCHECK_KEYS"]
LOCATIONCHECK_HEADERS = config["LOCATIONCHECK_HEADERS"]